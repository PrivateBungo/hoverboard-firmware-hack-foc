...
#define N_MOT_MAX       50             // [rpm] Maximum motor speed limit (raised from 150: typical hoverboard wheel needs ~400 rpm at 15 km/h; 550 gives headroom without stressing the FETs)
