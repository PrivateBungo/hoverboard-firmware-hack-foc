...
// or use VARIANT environment variable for example like "make -e VARIANT=VARIANT_NUNCHUK". Select only one at a time.
  ...
  #define VARIANT_USART       // Variant for Serial control via USART3 input; USART2 unused
...
#endif
#define TIMEOUT                50     // number of wrong / missing input commands before emergency off
...
#define FIELD_WEAK_HI   900             // (1000, 1500] Input target High threshold for reaching maximum Field Weakening / Phase Advance. Do NOT set this higher than 1500.
...
#define INACTIVITY_TIMEOUT        525600       // Minutes of not driving until poweroff. it is not very precise.
...
// ############################ VARIANT_USART SETTINGS ############################
  ...
  #define CONTROL_SERIAL_USART3  0    // right sensor board cable, primary input. Disable if I2C (nunchuk or lcd) is used! For Arduino control check the hoverSerial.ino
  #define FEEDBACK_SERIAL_USART3      // right sensor board cable, disable if I2C (nunchuk or lcd) is used!
  ...
  #define PRI_INPUT2             3, -1000, 0, 1000, 0     // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    ...
    #define SIDEBOARD_SERIAL_USART2 1   // left sideboard (USART3 is used for primary control)
    // #define SIDEBOARD_SERIAL_USART3 1   // right sideboard (already used for primary control/feedback)
    #define AUX_INPUT1           3, -1000, 0, 1000, 0     // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define AUX_INPUT2           3, -1000, 0, 1000, 0     // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #else
    ...
    // #define DEBUG_SERIAL_USART2         // left sensor cable debug output (USART3 is used for feedback/control)
  #endif
