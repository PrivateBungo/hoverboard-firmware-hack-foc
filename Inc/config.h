...
#define CTRL_MOD_REQ    TRQ_MODE        // [-] Control mode request: OPEN_MODE, VLT_MODE, SPD_MODE, TRQ_MODE (default here for Step-E outer velocity PI testing). Note: SPD_MODE and TRQ_MODE are only available for CTRL_FOC!
