...
- `control_tuning/velocity_setpoint_tuning.h`: longitudinal speed-intent mapping, setpoint-shaper tuning (`LONG_*`, `SETPOINT_*`), and Step-D slip-aware soft-limit settings (`SOFT_LIMIT_*`).
